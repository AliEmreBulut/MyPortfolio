export const styles = {
  ...
  mainCard: "p-8 max-md:p-6 overflow-hidden",
  mainCardContent: "max-w-3xl mx-auto mb-7 text-center",
  mainCardSubTitle: "text-brand-green text-sm font-extrabold tracking-widest uppercase mb-3",
  mainCardTitle: "m-0 mb-3 text-white text-[clamp(34px,5vw,58px)] leading-none tracking-tight",
  mainCardDesc: "m-0 mx-auto max-w-2xl text-slate-300/70 text-base leading-relaxed",
  
  grid: "grid grid-cols-5 gap-3.5 max-xl:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1",
