export const styles = {
  ...
  chipsContainer: "flex flex-wrap gap-2.5 mb-6 [&>span]:inline-flex [&>span]:items-center [&>span]:min-h-[40px] [&>span]:px-4 [&>span]:rounded-full [&>span]:border [&>span]:border-white/10 [&>span]:bg-gradient-to-b [&>span]:from-white/10 [&>span]:to-white/5 [&>span]:text-slate-200 [&>span]:text-sm [&>span]:font-bold [&>span]:transition-all [&>span]:duration-200 [&>span:hover]:-translate-y-0.5 [&>span:hover]:border-brand-green/30 [&>span:hover]:bg-brand-green/10",
