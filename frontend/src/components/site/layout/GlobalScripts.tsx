...
export default function GlobalScripts() {
  useEffect(() => {
    // 0. Tarayıcı önbelleğinden gelen scroll konumunu kapat ve en üste çık
    ...
    const codeWall = document.querySelector<HTMLElement>(".code-wall");
    ...
    // Cleanup: Tüm listener'ları ve observer'ları temizle
    return () => {
